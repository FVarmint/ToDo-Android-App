...
/**
 * Custom implementation of TextInputLayout to modify the hint being displayed when the layout is
 * being drawn. Useful if multiple languages are supported for users.
 */
