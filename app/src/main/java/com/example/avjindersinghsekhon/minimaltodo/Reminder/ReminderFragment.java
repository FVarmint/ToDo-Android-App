...
public class ReminderFragment extends AppDefaultFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        theme = getActivity().getSharedPreferences(MainFragment.THEME_PREFERENCES, MODE_PRIVATE)
        ...
        Button mRemoveToDoButton = (Button) view.findViewById(R.id.toDoReminderRemoveButton);
        TextView mtoDoTextTextView = (TextView) view.findViewById(R.id.toDoReminderTextViewBody);
        TextView mSnoozeTextView = (TextView) view.findViewById(R.id.reminderViewSnoozeTextView);
    ...
    private Date addTimeToDate(int min) {
        Date date = new Date();
